...
async function run() {
  ...
  assert.equal(context.core.activeCoreItems('task')[0].helperRefs[changedCreateScope],changedCreateDeck.id,'a mismatched create rollback keeps the task linked to its surviving deck');
